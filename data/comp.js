...
const COMP_DATA = {
  kicks: {
    ...
    models: [
      ...
      { brand:'MAZDA',      name:'CX-30',       color:'#34d399', ext:'進口延伸', data:{jan:187,feb:129,mar:474,apr:173,may:339,jun:215} },
      ...
      { brand:'MAZDA',      name:'CX-3',        color:'#6ee7b7', ext:'進口延伸', data:{jan:6,feb:21,mar:63,apr:30,may:38,jun:38} },
    ]
  },
  sentra: {
    label: '戰場② 中型房車',
    ...
    models: [
      ...
      { brand:'HONDA',  name:'Fit e:HEV',     color:'#fb7185', ext:'掀背延伸', data:{jan:520,feb:238,mar:405,apr:199,may:217,jun:246} },
      { brand:'MAZDA',  name:'MAZDA3',        color:'#34d399', ext:'進口延伸', data:{jan:140,feb:58,mar:297,apr:257,may:134,jun:284} },
      { brand:'FORD',   name:'FOCUS',         color:'#60a5fa', note:'已近停產尾量', data:{jan:1,feb:106,mar:65,apr:3,may:0,jun:0} },
    ]
  },
  xtrail: {
    label: '戰場③ 國產中大型SUV',
    ...
    models: [
      ...
      { brand:'TOYOTA', name:'Corolla Cross',  color:'#f97316', data:{jan:4604,feb:2441,mar:3565,apr:3573,may:3917,jun:4551} },
      { brand:'FORD',   name:'Territory',      color:'#60a5fa', data:{jan:1333,feb:838,mar:1257,apr:1294,may:857,jun:1276} },
      { brand:'HONDA',  name:'CR-V',           color:'#fb7185', note:'4月0台／5月57台為大改款交替期，6月回升', data:{jan:840,feb:589,mar:1114,apr:0,may:57,jun:1089} },
      ...
      { brand:'FORD',   name:'KUGA',           color:'#93c5fd', note:'5–6月近0，因全面停產', data:{jan:132,feb:59,mar:161,apr:99,may:0,jun:7} },
    ]
  },
  xtraile: {
    label: '戰場④ 進口中大型SUV',
    ...
    models: [
      ...
      { brand:'KIA',    name:'Sportage',        color:'#94a3b8', note:'6月952台暴增：電池八年延保＋優惠；7月初 TNCAP 撞擊2星，後續銷量再觀察', data:{jan:208,feb:164,mar:217,apr:158,may:338,jun:952} },
      { brand:'VW',     name:'Tiguan',          color:'#7dd3fc', data:{jan:123,feb:99,mar:116,apr:137,may:165,jun:126} },
      { brand:'MAZDA',  name:'CX-60',           color:'#6ee7b7', data:{jan:131,feb:64,mar:80,apr:227,may:107,jun:110} },
    ]
  }
};
