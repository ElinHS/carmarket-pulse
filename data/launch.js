...
const LAUNCH_2026 = [
  ...
  {ym:'2026-04', label:'4月', items:[
    ...
    {brand:'HYUNDAI', title:'MUFASA Xplore 特仕車（4/01）', type:'特仕',
     points:[
       '以「超規格 SUV」定位推出，入主價 86.9 萬元起',
       '提供戶外露營配件選購，將車款延伸至戶外休閒使用情境',
     ]},
  ]},
  ...
  {ym:'2026-08', label:'8月', items:[
    ...
    {brand:'HYUNDAI', title:'Palisade 上市（8/18）', type:'新車',
     points:[
       '8 月 18 日發表上市，大型七人座 SUV',
       '同步宣布由 SUPER JUNIOR 崔始源擔任代言人，以社群懸念預告帶動發表話題',
     ]},
  ]},
  {ym:'2026-09', label:'9月', items:[
    ...
    {brand:'HYUNDAI', title:'KONA Hybrid 大改款（9/19 起預售）', type:'預售',
     points:[
       '9 月 19 日啟動預接單，10 月正式發表',
       '雙車型編成：GLH-A 預售價 99 萬元、頂規 GLH-B 預售價 110 萬元',
       '產品訴求同級最佳油耗；高壓電池提供 8 年不限里程保固',
